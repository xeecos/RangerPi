...
Blockly.JavaScript['wait_until'] = function(block) {
  var until_value = Blockly.JavaScript.valueToCode(block, 'UNTIL_DO', Blockly.JavaScript.ORDER_COMMA);
  // until_value = eval(until_value) ? 0 : 9e10;
  // TODO: Assemble JavaScript into code variable.
  var code = 'while(!('+until_value+')){wait(0.5);}\n';
  return code;
};
