...
Blockly.Msg.MATH_CHANGE_TITLE = 'increase/decrease %1 by %2';
...
Blockly.Msg.DISPLAY_PLAY_TONE_ON = "play tone on";
Blockly.Msg.DISPLAY_STOP_TONE = "stop tone";

Blockly.Msg.DETECT_DISTANCE = "read ultrasonic sensor";
Blockly.Msg.DETECT_LIGHTNESS = "read lightness sensor";
Blockly.Msg.DETECT_DISTANCE_THRESHOLD = "obstacle detected";
Blockly.Msg.DETECT_LIGHTNESS_THRESHOLD = "robot receive light";
Blockly.Msg.START_DETECT_FACE = "start detect";
Blockly.Msg.FACE_STATUS = "read face's";
Blockly.Msg.EMOTION_STATUS = "read emotion's";
Blockly.Msg.FACE_TYPE = "face";
Blockly.Msg.EMOTION_TYPE = "emotion";

Blockly.Msg.EVENT_WHEN_SHAKE = "when tablet shaked";
Blockly.Msg.EVENT_SHAKE = "tablet shaked";
Blockly.Msg.EVENT_WHEN_OBSTACLE_AHEAD = "when obstacle detected";
Blockly.Msg.EVENT_WHEN_RECEIVE_LIGHT = "when robot receive light";
Blockly.Msg.EVENT_WHEN_BUTTON_ON_TOP_PRESSED = "when top button pressed";
Blockly.Msg.EVENT_WHEN_FACE_DETECTED = "when face detected";
Blockly.Msg.EVENT_WHEN_EMOTION_DETECTED = "when emotion detected";
Blockly.Msg.EVENT_TABLET_TILT_LEFT = "tablet tilt left";
Blockly.Msg.EVENT_TABLET_TILT_RIGHT = "tablet tilt right";
Blockly.Msg.EVENT_TABLET_TILT_FORWARD = "tablet tilt forward";
Blockly.Msg.EVENT_TABLET_TILT_BACKWARD = "tablet tilt backward";
Blockly.Msg.EVENT_LINEFOLLOWER = "line follower sensor =";
...
Blockly.Msg.Dialog_OVERWRITE = 'Overwrite the project?';
