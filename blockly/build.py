...
class Gen_compressed(threading.Thread):
  ...
  def gen_core(self):
    ...
    filenames = calcdeps.CalculateDependencies(self.search_paths,
        [os.path.join("core", "blockly.js"), os.path.join("blockly-extend", "goog_dependency.js")])
  ...
  def gen_generator(self, language):
    ...
    params.append(("js_code", "goog.provide('Blockly.utils');"))
    filenames = glob.glob(
  ...
  def do_compile(self, params, target_filename, filenames, remove):
    ...
    temp_file_path = target_filename+'_temp.js'
    f = open(temp_file_path, 'w')
    for (k,v) in params:
      if k=='js_code':
        f.write(v)
    f.close()
    arg_list = ["java", '-jar', 'compiler.jar', '--warning_level', 'QUIET', '--js_output_file', target_filename]
    for j in filenames:
      if j.startswith('../'):
        arg_list.append('--js')
        arg_list.append(j)
    arg_list.append('--js')
    arg_list.append(temp_file_path)
    # pp.pprint(arg_list)
...
https://developers.google.com/blockly/hacking/closure""")
  ...
  search_paths = calcdeps.ExpandDirectories(
      ["core", os.path.join(os.path.pardir, "closure-library"),  os.path.join("demos", "mblockly", "js")])
